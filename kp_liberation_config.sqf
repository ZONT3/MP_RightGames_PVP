...
GRLIB_secondary_missions_costs = [15, 15, 15];                          // Intel price for the secondary missions [FOB hunting, Convoy ambush, SAR].
...
GRLIB_defended_buildingpos_part = 2;                                    // Multiplier for defenders in buildings.
