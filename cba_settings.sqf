...
force ace_common_checkPBOsWhitelist = "['extdb3','CPMV22','Gun_H_R','Rocket_s_R','Gun_H_CP','CPTP_MNG_TP','Rocket_s_CP','GAU_Filters_C','CPTP_MNG_AH','XVS_Sound3DProcessors','CPAVP_S_F','Empty_Sound_C','RHeli_S_F','SonicBoomFX','CPAVP_C_F','RHS_Gatling762','RGatling','RHeli_C_F','RJet_S_F','fxp_VehPlane','AlG_breath','RJet_C_F']";
...
zen_faction_filter_2_BritishArmy = true;
