...
class mm_RscStructuredTextRight: mm_RscStructuredText {
	style = ST_RIGHT;
...
class mm_RscCombo {
	...
	arrowEmpty = "\A3\ui_f\data\GUI\RscCommon\rsccombo\arrow_combo_ca.paa";
	arrowFull = "\A3\ui_f\data\GUI\RscCommon\rsccombo\arrow_combo_active_ca.paa";
	class ComboScrollbar : mm_RscScrollbar {
		color[] = {1, 1, 1, 1};
		colorActive[] = {0, 0, 0, 1};
		colorDisabled[] = {};
		autoScrollEnabled = 1;
