...
if(isServer) then {
    ...
    GET_PARAM(GRLIB_resources_multiplier, "ResourcesMultiplier", 5);
    ...
    GET_PARAM(KP_liberation_respawn_cooldown, "RespawnCooldown", 0);
    ...
    GET_PARAM(GRLIB_halo_param, "HaloJump", 6);
